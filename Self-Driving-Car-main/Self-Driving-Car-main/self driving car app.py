...
class window(QtWidgets.QMainWindow):
   ...
   def forward(self):
      ...
      io.imsave(r'C:\Users\manoj\OneDrive\Desktop\self driving car\Python_Code\Self-Driving-Car-main\Self-Driving-Car-main\image\forward_'+str(fnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r'C:\Users\manoj\OneDrive\Desktop\self driving car\Python_Code\Self-Driving-Car-main\Self-Driving-Car-main\image\forward_'+str(fnum)+".jpg"))
      fnum=fnum+1
   ...
   def right(self):
      ...
      self.s.write(b'r')
      img=io.imread(self.url)
      io.imsave(r'C:\Users\manoj\OneDrive\Desktop\self driving car\Python_Code\Self-Driving-Car-main\Self-Driving-Car-main\image\right_'+str(rnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r'C:\Users\manoj\OneDrive\Desktop\self driving car\Python_Code\Self-Driving-Car-main\Self-Driving-Car-main\image\right_'+str(rnum)+".jpg"))
      rnum=rnum+1
   ...
   def left(self):
      ...
      self.s.write(b'l')
      img=io.imread(self.url)
      io.imsave(r'C:\Users\manoj\OneDrive\Desktop\self driving car\Python_Code\Self-Driving-Car-main\Self-Driving-Car-main\image\left_'+str(lnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r'C:\Users\manoj\OneDrive\Desktop\self driving car\Python_Code\Self-Driving-Car-main\Self-Driving-Car-main\image\left_'+str(lnum)+".jpg"))
      lnum=lnum+1
   ...
   def backward(self):
      ...
      self.s.write(b'b')
      img=io.imread(self.url)
      io.imsave(r'C:\Users\manoj\OneDrive\Desktop\self driving car\Python_Code\Self-Driving-Car-main\Self-Driving-Car-main\image\backward_'+str(bnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r"C:\Users\manoj\OneDrive\Desktop\self driving car\Python_Code\Self-Driving-Car-main\Self-Driving-Car-main\image\backward_"+str(bnum)+".jpg"))
      bnum=bnum+1
   ...
   def stopdir(self):
      ...
      self.s.write(b's')
      img=io.imread(self.url)
      io.imsave(r'C:\Users\manoj\OneDrive\Desktop\self driving car\Python_Code\Self-Driving-Car-main\Self-Driving-Car-main\image\stop_'+str(snum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r'C:\Users\manoj\OneDrive\Desktop\self driving car\Python_Code\Self-Driving-Car-main\Self-Driving-Car-main\image\stop_'+str(snum)+".jpg"))
      snum=snum+1
